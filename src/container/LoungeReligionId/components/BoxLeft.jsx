...
const BoxLeft = ({ religionID }) => {
  ...
  useEffect(() => {
    (async () => {
      if (quickFactUseEffect) {
        const data = await axiosClients.get(`/religion/${religionID}`, {
  ...
  useEffect(() => {
    (async () => {
      const data = await axiosClients.get(`/religion/${religionID}/members`, {
        headers: authHeaderAndAccount(),
      });
      ...
      <div className="sibar-inner-wrapper">
        ...
        <div className="card mt--5 education">
          ...
          <div className="card-body">
            ...
            <p className="fs--12">
              <a
                href={`https://develop.divj4fmlgk8ov.amplifyapp.com/auth/login/${religionID}`}
                target="_blank"
            ...
            <p className="fs--12">
              <a href={`/writing/${religionID}`} className="bright-blue">
                Writings
              </a>
            </p>
